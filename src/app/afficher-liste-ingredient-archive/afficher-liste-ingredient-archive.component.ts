...
@Component({
  selector: 'app-afficher-liste-ingredient-archive',
  templateUrl: './afficher-liste-ingredient-archive.component.html',
  styleUrls: ['./afficher-liste-ingredient-archive.component.css']
})
export class AfficherListeIngredientArchiveComponent implements OnInit{
  user:any;
  listeId: any;
  selectedListeId :any;
  liste : any;
